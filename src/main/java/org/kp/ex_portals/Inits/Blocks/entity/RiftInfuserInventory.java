 ...
 */
@FunctionalInterface
public interface RiftInfuserInventory extends SidedInventory {
    /**
     ...
     */
    static RiftInfuserInventory of(DefaultedList<ItemStack> items) {
        return () -> items;
    }
     ...
     * @return a new inventory
     */
    static RiftInfuserInventory ofSize(int size) {
